...
# select * from modelo where nombre like ('Must_ng'); # Comodin de un espacio (o un caracter) es el _
# select * from modelo where nombre like ('must%ng'); # Comodin de muchos espacios (o muchos caracter) es el %
#
# # Comparadores de fechas
# select * from modelo where fecha_fabricacion >= '2020-07-11' and fecha_fabricacion < '2020-07-20';
# select * from modelo where fecha_fabricacion not between '2020-06-11' and '2020-06-20';
#
# # Comparadores de listas
# select * from modelo where marca in (select idmarca from marca where nombre like ('Chevr%') or nombre like ('Ford'));
# select idmarca from marca where nombre like ('Chevr%') or nombre like ('Ford');
